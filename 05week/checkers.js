...
function Board() {
  ...
  this.createCheckers = function() {
    ...
    const blackPositions =
      ...
      // Both colors of checkers need to be .push to the grid depending on the index
      // of their position. Those position indexs are ran through the loop to be placed on the grid
    for (var i = 0; i <= 11; i++) {
...
function Game() {
  ...
  this.start = function() {
    this.board.createGrid();
     //Here we start placing checkers onto the board
   ...
   this.moveChecker = function(start, end) {
     ...
     //setting variables to find the start and end spot of the move to jump a checker
      ...
      const square1 = (startRow + endRow) / 2;
      const square2 = (startColumn + endColumn) / 2;
      const killPosition = [square1, square2];
